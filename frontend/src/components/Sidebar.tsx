...
const linkClass = 'flex items-center gap-2 px-3 py-2 hover:no-underline hover:bg-custom-active rounded-sm text-base'
const linkSubClass = 'flex gap-2 w-52 px-2 items-center hover:no-underline hover:bg-custom-active rounded-sm text-base'
const ListClass = 'flex gap-2 px-2 items-center  hover:no-underline rounded-sm text-white'
        ...
        <div className="flex main-div flex-col z-10 justify-between w-72 h-full bg-primary-700 shadow-primary-800">
            <div className="main-div flex flex-col fixed h-screen z-10  w-72 p-3 text-white">
                <div className=" lg:flex flex-nowrap px-4 py-7">
                    ...
                    <img src={SideBarArrow} onClick={() => toggleSideBar()} alt="My Icon" className="sideBarArrow" />
                </div>
                ...
                <div onClick={() => SetUserLink(!UserLink)} className="py-2 cursor-pointer flex flex-col gap-0.5">
                    <div>
                        <a className={classNames(ListClass)}>
                            <div style={{ marginLeft: '1rem' }} className={'flex gap-2 px-2 py-2 items-center'}>
                                <img src={IconSideControl} />
                                <p id="remove-p" className="text-sm text-black">
                                    Controle de acesso
                                </p>
                                <img style={{ marginLeft: 'auto' }} src={UpArrow} alt="Up Arrow" />
                            </div>
                        </a>
                    </div>
                </div>
                <div
                    className={classNames(
                        UserLink ? 'flex justify-center items-center w-full flex-col ml-5' : 'hidden'
                    )}
                >
                    <div className="w-52 flex-col ">
                        ...
                        >
                            <div style={{ marginLeft: '1rem', marginTop: '0' }} className={linkClass}>
            ...
            <div style={{ marginTop: '88vh' }} className="flex flex-col gap-0.5 pt-2 border-t border-neutral-700">
